const calculateFov = (event) => {
  ...
  const focalLength = parseFloat(
    document.getElementById("focalLength").value || 50
  );
  ...
  document.getElementById("result").innerHTML = `
        <div>
            <div class="card-body text-white">
                <h5 class="card-text"><strong>Horizontal FOV: ${horizontalFOV.toFixed(
                  2
                )} m</strong></h5>
                <h5 class="card-text"><strong>Vertical FOV: ${verticalFOV.toFixed(
                  2
                )} m</strong></h5>
                <h5 class="card-text"><strong>Diagonal FOV: ${diagonalFOV.toFixed(
                  2
                )} m</strong></h5>
            </div>
        </div>
